package com.pablo.system.common.util;
...
public class CacheUtil {
    ...
    private static RedisTemplate<String, Object> redisTemplate = CacheContextUtil.getBean(GlobalConfig.REDIS_TEMPLETE, RedisTemplate.class);

    private static StringRedisTemplate stringRedisTemplate = CacheContextUtil.getBean(GlobalConfig.STRING_REDIS_TEMPLETE, StringRedisTemplate.class);
